            ...
            <ul class="menu">
                ...
                <li class="menu-item-has-children active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class=" active"><a href="http://www.smkn1-sby.sch.id/profil/struktur">Struktur Organisasi</a></li>
    ...
    <section class="sub-banner sub-banner-course">
        ...
        <div class="container">
            <div class="sub-banner-content">
                <h2 class="text-center">SMK NEGERI 1 SURABAYA</h2>
            </div>
        </div>
    </section>
    <!-- END / SUB BANNER -->
                ...
                <div class="col-md-12">
                    <div class="avatar-acount">  
                        <div class="info-acount">
                            <h3 class="md black">Struktur Organisasi</h3>
                            <div style="text-align: center;">
                                <img id="bg" src="http://www.smkn1-sby.sch.id/storage/images/struktur.jpg" alt="">
                            </div>
